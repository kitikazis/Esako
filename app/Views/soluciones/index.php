...
<?php foreach ($soluciones as $sol): ?>
  <div class="sol-col">
    ...
    <div class="sol-col-text"><?= nl2br(View::e($sol['titulo'])) ?></div>
    <?php if ($sol['cta_wa']): ?>
    <div class="sol-cta">
      <a href="<?= View::e($sol['cta_wa']) ?>" class="sol-btn sol-btn-wa" target="_blank" rel="noopener">
      ...
      <a href="<?= View::e($sol['cta_tienda']) ?>" class="sol-btn sol-btn-shop" target="_blank" rel="noopener">
